...
class CertificateController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.delaware.certificates.index', compact('certificates', 'stats'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.delaware.certificates.create', compact('enrollments'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($enrollment->course->state !== 'delaware') {
            return redirect()->back()->with('error', 'Invalid enrollment selection.');
        }

        if ($enrollment->certificate) {
            return redirect()->route('admin.delaware.certificates.index')
        ...
        return redirect()->route('admin.delaware.certificates.show', $certificate)
            ->with('success', 'Delaware certificate created successfully.');
    }
    ...
    public function show(Certificate $certificate)
    {
        ...
        return view('admin.delaware.certificates.show', compact('certificate'));
    }

    public function edit(Certificate $certificate)
    {
        return view('admin.delaware.certificates.edit', compact('certificate'));
    }
    ...
    public function update(Request $request, Certificate $certificate)
    {
        ...
        return redirect()->route('admin.delaware.certificates.show', $certificate)
            ->with('success', 'Delaware certificate updated successfully.');
    }
    ...
    public function destroy(Certificate $certificate)
    {
        ...
        return redirect()->route('admin.delaware.certificates.index')
            ->with('success', 'Delaware certificate deleted successfully.');
    }
