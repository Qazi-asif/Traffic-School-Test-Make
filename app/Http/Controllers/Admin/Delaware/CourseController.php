...
class CourseController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.delaware.courses.index', compact('courses'));
    }

    public function create()
    {
        return view('admin.delaware.courses.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.delaware.courses.show', $course)
            ->with('success', 'Delaware course created successfully.');
    }
    ...
    public function show(Course $course)
    {
        ...
        return view('admin.delaware.courses.show', compact('course', 'stats', 'recentEnrollments'));
    }

    public function edit(Course $course)
    {
        return view('admin.delaware.courses.edit', compact('course'));
    }
    ...
    public function update(Request $request, Course $course)
    {
        ...
        return redirect()->route('admin.delaware.courses.show', $course)
            ->with('success', 'Delaware course updated successfully.');
    }

    public function destroy(Course $course)
    {
        if ($course->enrollments()->count() > 0) {
            return redirect()->route('admin.delaware.courses.index')
        ...
        return redirect()->route('admin.delaware.courses.index')
            ->with('success', 'Delaware course deleted successfully.');
    }
