...
class ChapterController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.texas.chapters.index', compact('chapters', 'courses'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.texas.chapters.create', compact('course', 'courses'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.texas.chapters.show', $chapter)
            ->with('success', 'Texas chapter created successfully.');
    }
    ...
    public function show(Chapter $chapter)
    {
        ...
        return view('admin.texas.chapters.show', compact('chapter', 'stats'));
    }

    public function edit(Chapter $chapter)
    {
        $courses = Course::where('state', 'texas')->orderBy('title')->get();
        return view('admin.texas.chapters.edit', compact('chapter', 'courses'));
    }
    ...
    public function update(Request $request, Chapter $chapter)
    {
        ...
        return redirect()->route('admin.texas.chapters.show', $chapter)
            ->with('success', 'Texas chapter updated successfully.');
    }
    ...
    public function destroy(Chapter $chapter)
    {
        ...
        return redirect()->route('admin.texas.chapters.index')
            ->with('success', 'Texas chapter deleted successfully.');
    }
}