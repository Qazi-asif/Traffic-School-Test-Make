...
class EnrollmentController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.texas.enrollments.index', compact('enrollments', 'courses', 'stats'));
    }

    public function create()
    {
        $users = User::orderBy('first_name')->orderBy('last_name')->get();
        $courses = Course::where('state', 'texas')->where('is_active', true)->orderBy('title')->get();

        return view('admin.texas.enrollments.create', compact('users', 'courses'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.texas.enrollments.show', $enrollment)
            ->with('success', 'Texas enrollment created successfully.');
    }
    ...
    public function show(UserCourseEnrollment $enrollment)
    {
        ...
        return view('admin.texas.enrollments.show', compact('enrollment', 'stats'));
    }
    ...
    public function edit(UserCourseEnrollment $enrollment)
    {
        ...
        return view('admin.texas.enrollments.edit', compact('enrollment', 'users', 'courses'));
    }
    ...
    public function update(Request $request, UserCourseEnrollment $enrollment)
    {
        ...
        return redirect()->route('admin.texas.enrollments.show', $enrollment)
            ->with('success', 'Texas enrollment updated successfully.');
    }
    ...
    public function destroy(UserCourseEnrollment $enrollment)
    {
        ...
        return redirect()->route('admin.texas.enrollments.index')
            ->with('success', 'Texas enrollment deleted successfully.');
    }
}