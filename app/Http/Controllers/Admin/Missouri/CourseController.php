...
class CourseController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.missouri.courses.index', compact('courses'));
    }

    public function create()
    {
        return view('admin.missouri.courses.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.missouri.courses.show', $course)
            ->with('success', 'Missouri course created successfully.');
    }
    ...
    public function show(Course $course)
    {
        ...
        return view('admin.missouri.courses.show', compact('course', 'stats', 'recentEnrollments'));
    }

    public function edit(Course $course)
    {
        return view('admin.missouri.courses.edit', compact('course'));
    }
    ...
    public function update(Request $request, Course $course)
    {
        ...
        return redirect()->route('admin.missouri.courses.show', $course)
            ->with('success', 'Missouri course updated successfully.');
    }

    public function destroy(Course $course)
    {
        if ($course->enrollments()->count() > 0) {
            return redirect()->route('admin.missouri.courses.index')
        ...
        return redirect()->route('admin.missouri.courses.index')
            ->with('success', 'Missouri course deleted successfully.');
    }
