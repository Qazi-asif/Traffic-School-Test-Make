...
{
    protected $table = 'missouri_quiz_questions';
    ...
    public function scopeByQuizSet($query, $set)
    {
        return $query->where('quiz_set', $set);
    }

    public function scopeByRotationGroup($query, $group)
    {
        return $query->where('rotation_group', $group);
    }
