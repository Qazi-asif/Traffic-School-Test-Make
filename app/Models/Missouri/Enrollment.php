...
{
    protected $table = 'missouri_enrollments';
    ...
    protected $casts = [
        ...
        'form_4444_generated' => 'boolean',
        'form_4444_sent' => 'boolean',
    ...
    {
        return $this->hasOne(MissouriForm4444::class, 'enrollment_id');
    }
    ...
    public function scopeRequiresForm4444($query)
    {
        return $query->whereHas('course', function ($q) {
            $q->where('requires_form_4444', true);
        });
    }

    public function scopeForm4444Generated($query)
    {
        return $query->where('form_4444_generated', true);
    }
}