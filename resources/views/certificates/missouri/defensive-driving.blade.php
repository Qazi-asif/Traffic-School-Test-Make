...
<head>
    ...
    <title>Missouri Defensive Driving Certificate - {{ $certificate->certificate_number }}</title>
    <style>
        @page {
            margin: 0.5in;
            size: 8.5in 11in;
...
<body>
    <div class="certificate-container">
        ...
        <div class="approval-number">
            MO Approval #:<br>
            <strong>{{ $course->approval_number ?? 'MO-2024-001' }}</strong>
        </div>
        ...
        <div class="header">
            ...
            <div>Missouri Defensive Driving Course</div>
        </div>
        ...
        <div class="completion-text">
            <strong>{{ $certificate->required_hours ?? 8 }}-Hour Missouri Defensive Driving Course</strong><br>
            as approved by the Missouri Department of Revenue<br>
            and authorized under Missouri Revised Statutes Section 302.309
        </div>
        
        <!-- Form 4444 Notice -->
        @if($course->requires_form_4444 ?? true)
        <div class="form-4444-notice">
            <strong>FORM 4444 COMPLIANCE:</strong> This certificate satisfies Missouri Form 4444 requirements<br>
            for point reduction and insurance discount eligibility.
        </div>
        @endif
        ...
        <div class="details-grid">
            ...
            <div class="details-row">
                ...
                <div class="details-cell value">{{ $certificate->required_hours ?? 8 }} Hours</div>
            </div>
            <div class="details-row">
            ...
            <div class="details-row">
                ...
                <div class="details-cell value">{{ number_format($certificate->final_exam_score, 1) }}% (Passing: 70%)</div>
            </div>
            <div class="details-row">
        ...
        <div class="signature-section">
            ...
            <div class="signature-cell">
                ...
                <div style="font-size: 10px;">Missouri Certified</div>
            </div>
        </div>
        
        <!-- State Seal -->
        @if(isset($state_stamp) && $state_stamp)
            <img src="{{ $state_stamp->image_url }}" alt="Missouri State Seal" class="state-seal">
        @else
        ...
        <div class="footer-text">
            This certificate is issued in compliance with Missouri Revised Statutes Section 302.309<br>
            and Missouri Department of Revenue regulations for defensive driving courses.<br>
