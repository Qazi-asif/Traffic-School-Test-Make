...
<head>
    ...
    <title>Florida BDI Certificate - {{ $certificate->certificate_number }}</title>
    <style>
        @page {
            margin: 0.5in;
            size: 8.5in 11in;
...
<body>
    <div class="certificate-container">
        ...
        <div class="dicds-info">
            DICDS Approved<br>
            Course ID: {{ $course->dicds_course_id ?? 'FL-BDI-001' }}
        </div>
        ...
        <div class="header">
            ...
            <div>Florida Basic Driver Improvement (BDI) Course</div>
        </div>
        ...
        <div class="completion-text">
            <strong>4-Hour Florida Basic Driver Improvement Course</strong><br>
