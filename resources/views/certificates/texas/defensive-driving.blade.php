...
<head>
    ...
    <title>Texas Defensive Driving Certificate - {{ $certificate->certificate_number }}</title>
    <style>
        @page {
            margin: 0.5in;
            size: 8.5in 11in;
...
<body>
    <div class="certificate-container">
        ...
        <div class="tdlr-info">
            TDLR Approved<br>
            Course ID: {{ $course->tdlr_course_id ?? 'TDLR-2024-001' }}
        </div>
        ...
        <div class="header">
            ...
            <div>Texas Defensive Driving Course</div>
        </div>
        ...
        <div class="completion-text">
            <strong>{{ $certificate->defensive_driving_hours ?? 6 }}-Hour Texas Defensive Driving Course</strong><br>
            as approved by the Texas Department of Licensing and Regulation (TDLR)<br>
            under Texas Education Code Chapter 1001
        </div>
        
        <!-- TDLR Notice -->
        <div class="tdlr-notice">
            <strong>TDLR APPROVED:</strong> This course meets all requirements for ticket dismissal<br>
            and insurance discount eligibility in the State of Texas.
        </div>
        ...
        <div class="details-grid">
            ...
            <div class="details-row">
                ...
                <div class="details-cell value">{{ $certificate->defensive_driving_hours ?? 6 }} Hours</div>
            </div>
            <div class="details-row">
            ...
            <div class="details-row">
                ...
                <div class="details-cell value">{{ number_format($certificate->final_exam_score, 1) }}% (Passing: 75%)</div>
            </div>
        </div>
        ...
        <div class="signature-section">
            ...
            <div class="signature-cell">
                ...
                <div style="font-size: 10px;">TDLR Certified</div>
            </div>
        </div>
        
        <!-- State Seal -->
        @if(isset($state_stamp) && $state_stamp)
            <img src="{{ $state_stamp->image_url }}" alt="Texas State Seal" class="state-seal">
        @else
        ...
        <div class="footer-text">
            This certificate is issued in compliance with Texas Education Code Chapter 1001<br>
            and Texas Department of Licensing and Regulation requirements.<br>
            Present this certificate to the court for ticket dismissal or to your insurance company for discount.
        </div>
    </div>
</body>
</html>