...
@section('title', 'Edit Chapter Break - ' . $course->title)
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2><i class="fas fa-edit me-2"></i>Edit Chapter Break</h2>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.chapter-breaks.update', [$courseType, $courseId, $break->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <select name="after_chapter_id" id="after_chapter_id" 
                                ...
                                @foreach($chapters as $chapter)
                                    <option value="{{ $chapter->id }}" 
                                            {{ old('after_chapter_id', $break->after_chapter_id) == $chapter->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="break_title" id="break_title" 
                                   ...
                                   value="{{ old('break_title', $break->break_title) }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="break_message" id="break_message" rows="3"
                                      ...
                                      placeholder="Optional message to display during the break...">{{ old('break_message', $break->break_message) }}</textarea>
                            @error('break_message')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <input type="number" name="break_duration_hours" id="break_duration_hours"
                                               ...
                                               value="{{ old('break_duration_hours', $break->break_duration_hours) }}" 
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <input type="number" name="break_duration_minutes" id="break_duration_minutes"
                                               ...
                                               value="{{ old('break_duration_minutes', $break->break_duration_minutes) }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" name="is_mandatory" id="is_mandatory" 
                                       value="1" {{ old('is_mandatory', $break->is_mandatory) ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="is_active" id="is_active" 
                                       value="1" {{ old('is_active', $break->is_active) ? 'checked' : '' }}>
                                <label class="form-check-label" for="is_active">
                                    <strong>Active</strong>
                                </label>
                                <div class="form-text">
                                    <i class="fas fa-play me-1"></i>
                                    Enable this break for students.
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card bg-light">
                                ...
                                <div class="card-body text-center">
                                    <div id="preview-content">
                                        <h4 id="preview-title">{{ $break->break_title }}</h4>
                                        <p id="preview-message" class="text-muted">{{ $break->break_message ?: 'Take a moment to rest and reflect on what you\'ve learned.' }}</p>
                                        <div class="badge bg-primary fs-6" id="preview-duration">{{ $break->formatted_duration }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i>Update Chapter Break
                            </button>
                        </div>
                    </form>
                </div>
